...
<body>
    ...
    <div class="bg-gray-100">
        ...
        <div class="flex mx-8 pb-12 gap-4">
            <div id="account-navigation" class="h-fit bg-white px-8 py-8">
            ...
            <div class="flex flex-1">
                <div class="flex flex-1 flex-col gap-6">
                    <div class="bg-white flex flex-1 flex-col px-8 py-8">
                        ...
                        <div class="border border-gray-200 py-8 px-4 mt-8">
                            <form action="<?=ROOT?>/account" method="post">
                                ...
                                <fieldset>
                                    <div class="flex flex-col sm:flex-row gap-12 w-full mt-12 mb-6">
                                        <div class="w-full sm:w-1/2 relative group">
                                            <label class="flex items-center text-xs text-gray-500">Current Password</label>
                                            <input type="password" name="current-password" required minlength="3" maxlength="1000" class="border-b w-full h-10 text-sm outline-none">
                                        </div>
                                    </div>
                                    <div class="flex flex-col sm:flex-row gap-12 w-full mt-12 mb-6">
                                        <div class="w-full sm:w-1/2 relative group">
                                            <label class="flex items-center text-xs text-gray-500">New Password</label>
                                            <input type="password" name="new-password" required minlength="3" maxlength="1000" class="border-b w-full h-10 text-sm outline-none">
                                        </div>
                                        <div class="w-full sm:w-1/2 relative group">
                                            <label class="flex items-center text-xs text-gray-500">Confirm New Password</label>
                                            <input type="password" name="confirm-new-password" required minlength="3" maxlength="1000" class="border-b w-full h-10 text-sm outline-none">
                                        </div>
                                    </div>
                                    <p class="text-xs text-gray-500 my-10">We will always have your back, Hackett London does not share or sell presonal info.</p>
                                    <div class="flex gap-6 justify-center">
                                        <span class="uppercase py-2 px-8 text-sm font-medium tracking-wider bg-white text-[#1f2134] border-2 border-[#1f2134] cursor-pointer">Cancel</span>
                                        <button type="submit" name="send-set-password" class="uppercase py-2 px-6 bg-[#1f2134] text-white text-sm tracking-wider">Change password</button>
                                    </div>
                                </fieldset>
                            </form>
                        </div>
